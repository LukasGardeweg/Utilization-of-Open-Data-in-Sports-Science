...
# lemmatize words (singular/plural forms)
def lemmatize_word(word):
    doc = nlp(word)
    return doc[0].lemma_ if doc else word

# frequency counting with lemmatization
...
# count frequencies of all words (lemmatized)
frequencies = count_word_frequencies_lemmatized(all_words_wordcloud)

# only show words that are in the WordCloud (lemmatized)
